...
tv_flashcards_front_card    id  com.cengage.mobile.mindtap.dev:id/tv_flashcards_front_card
ib_flashcards_mastered_icon id  com.cengage.mobile.mindtap.dev:id/iv_flashcards_mastered_icon
tv_flashcards_back_card     id  com.cengage.mobile.mindtap.dev:id/tv_flashcards_back_card
...
tv_flashcard_or_quiz_score_mastered   id       com.cengage.mobile.mindtap.dev:id/tv_flashcard_or_quiz_score_mastered
tv_flashcard_or_quiz_score_total_number_of_questions id       com.cengage.mobile.mindtap.dev:id/tv_flashcard_or_quiz_score_total_number_of_questions
btn_flashcard_score_take_practice_quiz  id       com.cengage.mobile.mindtap.dev:id/btn_flashcard_score_take_practice_quiz
btn_flashcard_score_keep_studying   id       com.cengage.mobile.mindtap.dev:id/btn_flashcard_score_keep_studying
ll_practice_quiz_layout id  com.cengage.mobile.mindtap.dev:id/ll_practice_quiz_layout
simpleDraweeView_flashcards_front_card	id com.cengage.mobile.mindtap.dev:id/simpleDraweeView_flashcards_front_card
btn_FlipCard  id    com.cengage.mobile.mindtap.dev:id/menu_action_flip_card
btn_ShuffleCard  id  com.cengage.mobile.mindtap.dev:id/menu_action_shuffle_card
fm_flashcards_cards   id   com.cengage.mobile.mindtap.dev:id/fm_flashcards_cards
Add_flashCard         id  com.cengage.mobile.mindtap.dev:id/fab_flashcards
...
Front_Content     id     com.cengage.mobile.mindtap.dev:id/et_add_edit_flashcard_front_content
Definition        id       com.cengage.mobile.mindtap.dev:id/et_add_edit_flashcard_back_content
Save_button  id    com.cengage.mobile.mindtap.dev:id/menu_action_save_flashcard
btn_Edit_Delete_FlashCard   id   com.cengage.mobile.mindtap.dev:id/iv_flashcard_front_edit_delete_menu
...
tv_flashcards_got_it_tool_tip   id      com.cengage.mobile.mindtap.dev:id/tv_flashcards_got_it_tool_tip
