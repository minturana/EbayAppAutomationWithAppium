...
et_forgotpassword_email     xpath           //android.widget.EditText[contains(@resource-id,'et_forgotpassword_email')]
...
UpdateMessageOnPopUp       xpath      //android.widget.TextView[contains(@resource-id,'message')]
