...
action_save                       		xpath         	//android.widget.Button[contains(@text,'${val}')]
...
media_activity_video               		xpath      		//android.widget.VideoView[contains(@resource-id,'videoView')]
MoreOptionImage                         xpath   		//android.widget.ImageButton[@content-desc='More options']
