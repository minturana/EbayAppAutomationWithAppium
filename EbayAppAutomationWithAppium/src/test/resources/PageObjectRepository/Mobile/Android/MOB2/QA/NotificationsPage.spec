...
recycler_view			                      id	                   com.cengage.mobile.mindtap.dev:id/recycler_view
...
tv_notification_details_content	                      id	                   com.cengage.mobile.mindtap.dev:id/tv_notification_details_content
tv_notification_details_title	                      id	                   com.cengage.mobile.mindtap.dev:id/tv_notification_details_title
tv_notification_details_date_time                     id	                   com.cengage.mobile.mindtap.dev:id/tv_notification_details_date_time
iv_notification_details_category                      id	                   com.cengage.mobile.mindtap.dev:id/iv_notification_details_category
progressbar_container	                              id	                   com.cengage.mobile.mindtap.dev:id/progressbar_container
...
CheckBox_DoNotShowMeAgainMessage                    id             com.cengage.mobile.mindtap.dev:id/cb_easy_notification_donot_show_again_message                                        
...
content_container                                   id          com.cengage.mobile.mindtap.dev:id/content_container
==============================================================================================
