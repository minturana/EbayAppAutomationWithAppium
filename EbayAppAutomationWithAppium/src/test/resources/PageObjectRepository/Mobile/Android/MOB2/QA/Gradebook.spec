...
main_toolbar_Header  xpath   //android.view.View[contains(@resource-id,'main_tool
...
et_enter_passcode            id      com.cengage.mobile.mindtap.dev:id/et_enter_passcode
...
circleDisplay_percentage     id     com.cengage.mobile.mindtap.dev:id/circleDisplay_percentage
action_bar_root              id     com.cengage.mobile.mindtap.dev:id/action_bar_root
...
recycler_view_gradebook     id      com.cengage.mobile.mindtap.dev:id/recycler_view_gradebook
